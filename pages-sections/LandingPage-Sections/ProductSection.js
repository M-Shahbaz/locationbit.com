        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={4}>
            <InfoArea
              ...
              description="Locationbit will have a meaningful data of local businesses and locations while any third party get a free way to access the world's location data."
              icon={LocationOnIcon}
              iconColor="info"
              vertical
            />
