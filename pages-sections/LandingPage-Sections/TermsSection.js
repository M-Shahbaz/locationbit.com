      ...
      <GridContainer justify="center">
        <GridItem cs={12} sm={12} md={8}>
          ...
          <div class="align-left" className={classes.description}>
            ...
            <div class="captions">
              <div class="">
                <h3 class="heading">Welcome to Locationbit.com!</h3>
                <p class="heading-text">Thanks for using our service. The Service is provided by Locationbit.com (“Locationbit.com”). <br />
            ...
            <div class="captions">
              <div class="">
                <h3 class="heading">Using our Services</h3>
                <p class="heading-text">You must follow any policies made available to you within the Services.<br />
            ...
            <div class="captions">
              <div class="">
                <h3 class="heading">Privacy and Copyright Protection</h3>
                <p class="heading-text">We don’t collect your account password in anyway only your email address and your public information at the time of authentication with Locationbit.com Google Application.<br />
            ...
            <div class="captions">
              <div class="">
                <h3 class="heading">Access to the Website</h3>
                <p class="heading-text">The Website is made available free of charge and the Services are available only for informational purposes.
            ...
            <div class="captions">
              <div class="">
                <h3 class="heading">Modifying and Terminating our Services</h3>
                <p class="heading-text">We are constantly changing and improving our Services. We may add or remove functionalities or features, and we may suspend or stop a Service altogether.<br />
            ...
            <div class="captions">
              <div class="">
                <h4 class="heading">You are encouraged to send comments, improvements or suggestions at locationbit.com@gmail.com </h4>
