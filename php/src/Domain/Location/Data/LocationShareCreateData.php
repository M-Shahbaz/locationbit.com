...
final class LocationShareCreateData
{
    /** @var string (varchar)*/
    public $locationId;      
	...
	private function validateLocationShareCreateData() 
	{
    ...
    {
		switch ($type) {
			case 'validateLocationShareCreateData':
				return $this->validateLocationShareCreateData();
				break;
